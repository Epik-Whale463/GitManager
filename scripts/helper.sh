...
read_choice() {
    ...
    case $choice in
        ...
        9) learn_with_gitllm ;;  # Add this line for option 9
        *) print_color "$RED" "Please choose a number between 1 and 9."; sleep 2 ;;
    esac
}

# Function to learn with GitLLM
learn_with_gitllm() {
    echo "Starting GitLLM chat..."
    python3 llm.py chat
}
